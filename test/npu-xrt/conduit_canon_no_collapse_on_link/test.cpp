...
//
// Pre-fix (canon over-collapses on the LINKED @in_L3L2 channel): HW
// dispatch hangs (XRT timeout — same failure mode as the Llama prefill
// attn_scores GEMM).  Post-fix: dispatch completes byte-equivalent to
// the reference computed below.
...
int main(int argc, const char *argv[]) {
  cxxopts::Options options("conduit_canon_no_collapse_on_link");
