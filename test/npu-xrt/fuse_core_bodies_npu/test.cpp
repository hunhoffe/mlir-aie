...
//===----------------------------------------------------------------------===//
//
// XRT host harness for `--conduit-fuse-core-bodies` (loop-body fusion) HW
// smoke.  E2E companion to lit-only pins
...
// the Pattern E forward-chain mis-fusion class — merged-core hangs on the
// SECOND invocation, not the first.  Single dispatch alone would silently
// hide that failure mode.
//
...
int main(int argc, const char *argv[]) {
  cxxopts::Options options("fuse_core_bodies_npu");
  ...
  // source-order: ext_in_add, ext_out_mul.  After --conduit-fuse-spatial
