...
# CHECK:      aie.objectfifo @of3(%{{.*}}tile_0_0, {%{{.*}}tile_1_3}, 2 : i32) {transport = #aie.transport<stream, ends = consumer, port = 1>} : !aie.objectfifo<memref<256xi32>>
...
def objFifo_example():
    ...
    with InsertionPoint(dev_block):
        ...
        of3.set_transport(Transport.stream(ends="consumer", port=1))
