...
module {
  ...
  conduit.create {name = "chX", capacity = 32 : i64}
  conduit.create {name = "chY", capacity = 32 : i64}
  conduit.create {name = "chP", capacity = 16 : i64}
  conduit.create {name = "chQ", capacity = 16 : i64}
