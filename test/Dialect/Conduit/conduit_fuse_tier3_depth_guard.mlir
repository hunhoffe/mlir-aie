...
// CHECK:       conduit.create {{{.*}}fuse_mode = "static"{{.*}}fused_dma_channel_group{{.*}}name = "shallow_dma"
// CHECK:       conduit.create {{{.*}}fuse_mode = "static"{{.*}}fused_dma_channel_group{{.*}}name = "tier2_shallow"

func.func @fuse_tier3_depth1() {
  conduit.create {name = "shallow_dma", capacity = 8 : i64,
                  producer_tile = array<i64: 0, 2>,
                  consumer_tiles = array<i64: 0, 3>,
                  element_type = memref<8xi32>,
                  depth = 1 : i64}
  conduit.create {name = "tier2_shallow", capacity = 8 : i64,
                  producer_tile = array<i64: 0, 2>,
...
func.func @skip_tier3_depth2() {
  ...
  conduit.create {name = "deep_tier3", capacity = 16 : i64,
                  producer_tile = array<i64: 1, 2>,
                  consumer_tiles = array<i64: 1, 3>,
                  element_type = memref<8xi32>,
                  depth = 2 : i64}
  conduit.create {name = "tier2_partner", capacity = 8 : i64,
                  producer_tile = array<i64: 1, 2>,
...
// CHECK:       conduit.create {{{.*}}fuse_mode = "static"{{.*}}fused_dma_channel_group{{.*}}name = "t2_a"
// CHECK:       conduit.create {{{.*}}fuse_mode = "static"{{.*}}fused_dma_channel_group{{.*}}name = "t2_b"

func.func @fuse_tier2_only() {
  conduit.create {name = "t2_a", capacity = 8 : i64,
                  producer_tile = array<i64: 2, 2>,
                  consumer_tiles = array<i64: 2, 3>,
                  element_type = memref<8xi32>,
                  depth = 1 : i64}
  conduit.create {name = "t2_b", capacity = 8 : i64,
                  producer_tile = array<i64: 2, 2>,
