...
//                    + 3 rotation counter buffers, one per tile)
...
// --- Producer core: rotation counter as aie.buffer on tile (memref<2xi32>) ---
// CHECK:     aie.buffer({{.*}}) : memref<2xi32>
// CHECK:     aie.core({{.*}}tile_0_2{{.*}}) {
// CHECK:         memref.store {{.*}} : memref<2xi32>
// CHECK:       scf.for
...
// CHECK:         memref.store {{.*}} : memref<2xi32>
// CHECK:     }
// --- Consumer cores: rotation counters as aie.buffer on each tile ---
