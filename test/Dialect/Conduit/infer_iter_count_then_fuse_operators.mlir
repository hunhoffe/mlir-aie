...
// (ConduitFuseOperators.cpp lines 701-702 pass IntegerAttr{}). For the
// default shared-memory-routed intermediate this is moot (no shim BD
// replay). For a hypothetical DMA-routed intermediate (not exercised
// today), dma_repeat propagation through fusion would matter — file
// as PLAN.md backlog if/when needed.
