...
//
// Regression test: shim→MemTile relay (distribute) locks must be on the MemTile,
// NOT on the shim tile.
//
// Background:
//   For a conduit.distribute where the source conduit has a shim producer
...
//   conduit.distribute: weights_stage1 → weights  (1-to-1 relay)
