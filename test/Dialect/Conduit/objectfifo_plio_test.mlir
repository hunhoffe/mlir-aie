...
//
// Conduit must:
// 1. Emit aie.shim_dma_allocation with {conduit_channel = @of_0, plio = true}
...
// CHECK: aie.shim_dma_allocation @of_0_shim_alloc(%{{.*}}, MM2S, 0) {conduit_channel = @of_0, plio = true}
// CHECK: aie.shim_dma_allocation @of_1_shim_alloc(%{{.*}}, S2MM, 0) {conduit_channel = @of_1, plio = true}
// CHECK: aie.shim_dma_allocation @of_2_shim_alloc(%{{.*}}, S2MM, 1) {conduit_channel = @of_2, plio = true}
