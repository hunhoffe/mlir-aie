...
module @pkt_id_exactly_32 {
  aie.device(xcvc1902) {
    ...
    conduit.create {name = "p29", capacity = 4 : i64, producer_tile = array<i64: 7, 0>, consumer_tiles = array<i64: 7, 5>, element_type = memref<4xi32>, depth = 1 : i64, routing_mode = #conduit.routing_mode<packet>}
