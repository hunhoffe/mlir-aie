...
func.func @distribute_three_consumer_overflow() {
  ...
  // expected-error@+1 {{'conduit.distribute' op M7-dist composed-consume (Denolf Eq. 48): source buffer capacity insufficient for multi-consumer distribute: peak occupancy=12 exceeds source slot_elems =4 (bottleneck consumer: 't3_d3', hyper-period=4 steps; a container can only be freed after ALL 3 consumers have consumed it)}}
