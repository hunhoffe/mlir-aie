module {
  aie.device(npu1_1col) {
    ...
    func.func @passThroughLine(%arg0: memref<1024xui8>, %arg1: memref<1024xui8>, %arg2: i32) {
      %c0 = arith.constant 0 : index
      %0 = arith.index_cast %arg2 : i32 to index
      %c1 = arith.constant 1 : index
      scf.for %arg3 = %c0 to %0 step %c1 {
        %1 = memref.load %arg0[%arg3] : memref<1024xui8>
        memref.store %1, %arg1[%arg3] : memref<1024xui8>
      }
      return
    }
