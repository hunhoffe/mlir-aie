module {
  aie.device(npu1_1col) {
    ...
    aie.objectfifo @inOF_act_L3L2(%tile_0_0, {%tile_0_1, %tile_0_2}, [2 : i32, 4 : i32, 2 : i32]) : !aie.objectfifo<memref<32x1x256xi8>> 
    aie.objectfifo.link [@inOF_act_L3L2] -> [@skip_buf]([] [0])
    ...
    aie.objectfifo.link [@inOF_wts_0_L3L2] -> [@wts_buf_00, @wts_buf_01, @wts_buf_02]([] [0, 16384, 53248])
    ...
    aiex.runtime_sequence(%arg0: memref<262144xi8>, %arg1: memref<69632xui8>, %arg2: memref<262144xi8>) {
      aiex.npu.rtp_write(@rtpComputeTile2, 0, 1)
      aiex.npu.rtp_write(@rtpComputeTile4, 0, 1)
      aiex.npu.rtp_write(@rtpComputeTile4, 1, 0)
      %0 = aiex.dma_configure_task_for @inOF_act_L3L2 {
        aie.dma_bd(%arg0 : memref<262144xi8>, 0, 262144, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 262144, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @inOF_wts_0_L3L2 {
        aie.dma_bd(%arg1 : memref<69632xui8>, 0, 69632, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 69632, stride = 1>])
        aie.end
      }
