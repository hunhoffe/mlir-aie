...
The primary reuslts to verify from the evaluation are:
...
2. **Figure 2 Designs**
  The designs in Figure 2 are pared down examples from the [example_designs](example designs).
